...
-- personal variables
local browser           = "brave"
local editor            = os.getenv("nvim") or "vim"
local editorgui         = "mousepad"
...
local myawesomemenu = {
    { "hotkeys", function() return false, hotkeys_popup.show_help( _, awful.screen.focused() ) end },
    { "manual", terminal .. " -e 'man awesome'" },
    { "edit config", terminal.." vim /home/abdullah/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -p ' Apps :'",
    ...
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "brave" ) end,
     ...
     awful.key({ modkey, altkey }, "s", function () awful.util.spawn( "xfce4-settings-manager" ) end,
        {description = "Sistem Setting" , group = "gui apps" }),    
    awful.key({ modkey, altkey }, "f", function () awful.util.spawn( "pcmanfm" ) end,
        {description = "PcManFm" , group = "gui apps" }),  
    awful.key({ modkey }, "r", function () awful.util.spawn( "./.config/rofi/launchers/slate/launcher.sh" ) end,
        {description = "Rofi Launcher" , group = "gui apps" }),
    ...
    awful.key({ modkey1,           }, "space",   awful.tag.viewprev,
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey}, "Left", function () lain.util.move_tag(-1) end,
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "o",      function (c) c:move_to_screen()               end,
              {description = "move clinet to next screen", group = "client"}),
    awful.key({ modkey,           }, "n",
        function (c)
...
awful.spawn.easy_async("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1")
--os.execute("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1 &")

--Dual Monitor Setting
awful.spawn.easy_async("xrandr --output HDMI-1 --mode 1920x1080 --rate 74.99 --output eDP-1 --primary --mode 1366x768 --rate 60.00 --right-of HDMI-1")
